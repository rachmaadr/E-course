    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <div class="flex flex-row gap-x-10">
                    ...
                    <div class="flex flex-col gap-y-10">    
                        <div>
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">{{ $subscribeTransaction->total_amount }}</h3>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">{{ $subscribeTransaction->subcription_start_date }}</h3>
                        </div>
                        <div class="">
                            <p class="text-slate-500 text-sm">Student</p>
                            <h3 class="text-indigo-950 text-xl font-bold">
                                 {{ $subscribeTransaction->user }}
                            </h3>
                        </div>
                    </div>
                    <div>
                ...
                <hr class="my-5">
                <form action="{{ route('admin.subcription_transactions.update') }}" method="POST">
                    @csrf
                    @method('PUT')
