...
<body class="text-black font-poppins pt-10 pb-[50px]">
    ...
    <section id="Top-Categories" class="max-w-[1200px] mx-auto flex flex-col items-center p-[70px_50px] gap-[30px]">
        <div class="flex flex-col items-center gap-[30px] text-center">
            ...
            <div class="flex flex-col items-center">
                ...
                <p class="text-[#6D7786] text-lg -tracking-[2%]">Catching up on the on-demand skills and high-paying careers this year</p>
            </div>
        </div>

        <!-- Grid Container -->
        <div class="grid grid-cols-2 gap-[30px] lg:grid-cols-3 w-100">
            ...
            <a href="{{ route('front.category', 'ui-ux-design') }}" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                <div class="w-[70px] h-[70px] flex shrink-0">
                    <img src="assets/icon/Web Development 1-4.svg" class="object-contain" alt="icon">
                </div>
                <p class="font-bold text-lg text-center">UI/UX Design <span> Copywriting</p>
            </a>
        </div>
        <div class="grid grid-cols-1 gap-[30px] lg:grid-cols-1 w-100">
            <a href="{{ route('front.category', 'freelancing-journey') }}" class="card flex items-center p-4 gap-3 ring-1 ring-[#DADEE4] rounded-2xl hover:ring-2 hover:ring-[#FF6129] transition-all duration-300">
                ...
                <p class="font-bold text-lg text-center">Freelancing Journey</p>
            </a>
        </div>
    </section>
                ...
                @forelse ($courses as $course)
                    <div class="course-card w-1/3 px-3 pb-[70px] mt-[2px]">
                        <div class="flex flex-col rounded-t-[12px] rounded-b-[24px] gap-[32px] bg-white w-full pb-[10px] overflow-hidden transition-all duration-300 hover:ring-2 hover:ring-[#FF6129]">
                            <a href="{{ route('front.detail', $course->slug) }}" class="thumbnail w-full h-[200px] shrink-0 rounded-[10px] overflow-hidden">
                                <img src="{{ Storage::url($course->thumbnail) }}" class="w-full h-full object-cover" alt="thumbnail">
                            </a>
                            <div class="flex flex-col px-4 gap-[10px]">
                                <a href="{{ route('front.detail', $course->slug) }}" class="font-semibold text-lg line-clamp-2 hover:line-clamp-none min-h-[56px]">{{ $course->name }}</a>
